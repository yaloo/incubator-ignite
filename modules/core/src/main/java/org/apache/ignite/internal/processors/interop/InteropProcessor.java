...
public class InteropProcessor extends GridProcessorAdapter {
    ...
    public InteropMarshaller marshaller() {
        return new InteropMarshaller() {
            @Override public void writeObject(Object obj, InteropOutputStream out) {
                if (obj == null)
                    obj = 0;
            ...
            @Override public Object readObject(InteropInputStream in) {
                return in.readInt();
            }
        };
    }
